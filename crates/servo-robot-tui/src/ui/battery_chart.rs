...
pub fn render(f: &mut Frame, area: Rect, app: &App) {
    ...
    let charge_current_data: Vec<(f64, f64)> = app
        .battery_chart
        .charge_current
        .as_ref()
    ...
    if area.height > 3 {
        ...
        if is_charging {
            ...
            spans.push(Span::styled(
                format!("{:>5.1}V", charge_v),
                Style::default().fg(Color::LightCyan),
            ));
            spans.push(Span::raw(" "));
            spans.push(Span::styled("I:", Style::default().fg(Color::White)));
            spans.push(Span::styled(
                format!("{:>5.1}A", charge_i),
                Style::default().fg(Color::Yellow),
            ));
            spans.push(Span::raw(" "));
            spans.push(Span::styled("P:", Style::default().fg(Color::White)));
            spans.push(Span::styled(
                format!("{:>5.1}W", charge_power),
                Style::default().fg(Color::Yellow),
            ));
            spans.push(Span::raw(" "));
            spans.push(Span::styled("T:", Style::default().fg(Color::White)));
            spans.push(Span::styled(
                format!("{:>5.1}°C", charge_t),
                Style::default().fg(charge_temp_color),
            ));
        }
